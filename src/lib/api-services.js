...
export const siteSettingsApi = {
  ...
  getAdmin: () => apiClient.get('/site-settings/admin'),
...
// Inbox API (contact/newsletter)
export const inboxApi = {
  submitContact: (data) => apiClient.post('/inbox/contact', data),
  submitNewsletter: (data) => apiClient.post('/inbox/newsletter', data),
};
